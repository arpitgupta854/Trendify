...
import { Product } from "./Product"; // Assuming product data is stored here
  ...
  return (
    <>
      ...
      <div className="product-container">
        ...
        <button style={{width:"600px",height:"50px",fontSize:"2rem",marginTop:"20px" ,backgroundColor:"blueviolet",borderRadius:"15px",color:"white",fontWeight:"700",fontFamily:"Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif",border:"none",marginTop:"30px",textAlign:"center",justifyContent:"center"}}>
               Product Images
            </button>
            </div>
